...
| **E2E-01**  | E2E | AC-01, AC-04, AC-05 | Full Authentication lifecycle | Logs in, navigates role-specific UI, blocks URL hopping (redirects to sign-in boundary and blocks API), logs out | `client/tests/e2e/lab-03/authentication.spec.ts` | Pass |
